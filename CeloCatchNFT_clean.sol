...
// File @openzeppelin/contracts/token/ERC1155/extensions/IERC1155MetadataURI.sol@v5.6.1
...
// File @openzeppelin/contracts/token/ERC1155/utils/ERC1155Utils.sol@v5.6.1
...
// File @openzeppelin/contracts/token/ERC1155/ERC1155.sol@v5.6.1
...
// File contracts/CeloCatchNFT.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.24;

interface ICore { 
    function playerXP(address p) external view returns (uint256); 
}
...
contract CeloCatchNFT is ERC1155 {
    ...
    constructor(address _core) ERC1155("https://api.celocatch.com/nft/{id}.json") { 
        core = ICore(_core); 
    }
